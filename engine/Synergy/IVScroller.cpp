...
void IVScroller::Render() {
    ...
    SynUI::Draw(SynUI::Theme->_Frame, pos, GetSize(), glm::vec4(0.2f, 1, 1, 1));
    SynUI::Draw(SynUI::Theme->_Frame, glm::vec2(pos.x, pos.y + _CurrentValue), glm::vec2(_Size.x, dh),glm::vec4(1,1,1,1));
